...
run)
  ...
  #launch
  TERM=vt102 screen ./UDKGameServer-Linux AOCLTS-Arena3_p\?steamsockets\?Port=8000\?QueryPort=27015\?adminpassword=erased\?password=erased\?modname=BlackKnight -sdkfileid=232823090 -configsubdir="$CONFIG" -seekfreeloadingserver
  ;;
*)
  usage
  ;;
